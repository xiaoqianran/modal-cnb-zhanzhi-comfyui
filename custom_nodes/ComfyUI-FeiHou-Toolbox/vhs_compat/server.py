...
# Keep the vendored VHS server self-contained.  The public VHS paths are
# commonly registered by an installed VideoHelperSuite and duplicate aiohttp
# routes can make either extension fail to start.
@server.PromptServer.instance.routes.get("/feihou-vhs/viewvideo")
async def view_video(request):
    ...
    try:
        ...
        pass
    return resp
@server.PromptServer.instance.routes.get("/feihou-vhs/viewaudio")
...
query_cache = {}
@server.PromptServer.instance.routes.get("/feihou-vhs/queryvideo")
...
@server.PromptServer.instance.routes.get("/feihou-vhs/getpath")
