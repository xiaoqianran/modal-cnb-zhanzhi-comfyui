...
app.registerExtension({
    ...
    nodeCreated(node) {
        // toggle widgets
        if (OWN_NODES.has(node.comfyClass)) {
            if(node.widgets){
