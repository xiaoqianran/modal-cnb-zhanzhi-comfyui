...
class SFLoadAudioUI:
    ...
    def load_audio(self, audio, start_time, end_time, duration, **kwargs):
        ...
        if audio == "none" or not audio_path or not os.path.exists(audio_path):
            ...
            print(f"!!! [SFLoadAudioUI] Warning: Audio file '{missing_info}' not found. Outputting 1 second of silence.")
            ...
            try:
                ...
                print(f"!!! [SFLoadAudioUI] Error decoding {audio}: {e}. Falling back to silence.")
                sample_rate = 44100
                waveform = torch.zeros((2, 44100))
