    ...
    def load_images(self, image_paths, width, height, interpolation, resize_method, multiple_of, img_compression):
        ...
        if len(results) > 0:
            ...
            if all_same_shape:
                ...
                print("SFMultiImageLoader Warning: Images have different dimensions due to resize settings. Cannot batch into multi_output. Outputting zero tensor for the batch, but individual output nodes will still work fine.")
