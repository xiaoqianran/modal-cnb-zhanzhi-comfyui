...
class SFLTXSequencer(LTXVAddGuide):
    @classmethod
    def define_schema(cls):
        inputs = [
            ...
            io.Image.Input("multi_input", tooltip="Batched images from SFMultiImageLoader"),
        ]
        ...
        return io.Schema(
            node_id="SFLTXSequencer",
            display_name="SF-LTX Sequencer",
