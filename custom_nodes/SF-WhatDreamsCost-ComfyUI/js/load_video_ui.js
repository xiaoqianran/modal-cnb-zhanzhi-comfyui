...
app.registerExtension({
    name: "Comfy.SFLoadVideoUI",
    async beforeRegisterNodeDef(nodeType, nodeData, app) {
        if (nodeData.name === "SFLoadVideoUI") {
                        ...
                        try {
                            ...
                            if (checkResp.status === 200) {
                                ...
                                if (checkResult.exists) {
                                    console.log(`[SFLoadVideoUI] File already exists: ${checkResult.name}. Reusing existing file.`);
                            ...
                            console.warn("[SFLoadVideoUI] Failed to check for existing file, proceeding with upload", e);
                        }
