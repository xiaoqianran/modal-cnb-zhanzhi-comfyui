...
import { type Comfy } from '@/typings/comfy';

import { type IWidget, type LGraphNode } from './litegraph';

type ComfyApp = Comfy.App;
...
export interface ComfyExtension {
   ...
   * @param app The ComfyUI app instance
   */
  loadedGraphNode: (node: LGraphNode, app: ComfyApp) => any;
   ...
   * @param app The ComfyUI app instance
   */
  nodeCreated: (node: LGraphNode, app: ComfyApp) => any;
}
