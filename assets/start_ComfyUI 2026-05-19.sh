...
if [ $IS_L40 -eq 1 ]; then
    ...
    echo "🚀 Strategy: L40 (High Throughput Mode)"
else
    COMFY_ARGS+=(--cache-ram 4)
    echo "🚀 Strategy: H20 (Fast Switching Mode)"
fi
